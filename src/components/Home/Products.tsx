    ...
    const products = [
        {
            ...
            rating: 4.5,
            price: 99.99,
            imageUrl: "src/assets/flowers/sample.png",
            totalSell: 10,
            discount: 0
            ...
            <section className="flex flex-col gap-3">
                ...
                <div className="flex flex-wrap gap-5 justify-start">
                    {products.map((product) => (
                        <Card itemName={product.itemName} rating={product.rating} price={product.price} imageUrl={product.imageUrl} totalSell={product.totalSell} discount={product.discount} />
                    ))}

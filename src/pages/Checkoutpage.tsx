            ...
            <div className='flex flex-row flex-wrap lg:flex-nowrap  justify-evenly gap-2'>
                {selectedCarts && selectedCarts.length > 0 ? (
                    <>
                        ...
                        {/* Order Information */}
                        <div
                            className='lg:w-[56%] w-full lg:min-h-[75vh] h-fit lg:order-2 order-1 lg:border-l-2 relative px-2 flex flex-col gap-2'>
                            <h1 className='font-medium text-xl'>
                                Order Summary
                            </h1>
                            <motion.div
                                ...
                                <motion.div
                                    ...
                                    animate={{ opacity: 1, x: 0 }}
                                    transition={{ duration: 0.5 }}
                                    className='grid grid-cols-4 grid-rows-1 p-2 gap-2 shadow-sm bg-white rounded border'>
